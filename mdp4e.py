## Andrew Centa
## modified mdp4e.py for HW 4, #2

# changes:
# 1) changed gamma to 0.99 instead of 0.9 in the MDP init
# 2) changed the actions in grid transition model to match the directed model
...
# Changed gamma to be 0.99 - AC
    def __init__(self, init, actlist, terminals, transitions=None, reward=None, states=None, gamma=0.99):
        if not (0 < gamma <= 1):
...
class GridMDP(MDP):
    ...
    # changed the actions to match the transition model
