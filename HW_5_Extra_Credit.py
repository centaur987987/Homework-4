...
class Chicken:# create the agent/chicken class
    ...
    def ExtendSackOwnership(self, Chick_j_ID, ent_set):
        ...
        new_owners_i = list(self.sack_owner) + [Chick_j_ID]
        new_owners_j = list(ent_set.chickens[Chick_j_ID].sack_owner) + [self.index]

        
        # update chicken components
        updated_chicken = replace(self, sack_owner = new_owners_i)
        updated_j = replace(ent_set.chickens[Chick_j_ID], sack_owner = new_owners_j)
...
def main():
    ...
    print('chicken i sack owner')
    print(ent_set.chickens[6].sack_owner)
    print('chicken j sack owner')
    print(ent_set.chickens[1].sack_owner)
    ent_set = ent_set.chickens[6].ExtendSackOwnership(1, ent_set)
    print('chicken i sack owner after teaming up with j')
    print(ent_set.chickens[6].sack_owner)
    print('chicken j sack owner after teaming up with i')
    print(ent_set.chickens[1].sack_owner)
